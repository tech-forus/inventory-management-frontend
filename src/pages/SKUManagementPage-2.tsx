...
import { Search, Trash2, ChevronLeft, ChevronRight, ArrowUp, ArrowDown, ChevronsDown } from 'lucide-react';
...
const SKUManagementPage: React.FC = () => {
  ...
  const getStockStatus = (currentStock: number, minStockLevel: number): { label: string; color: string; bgColor: string } => {
    if (currentStock === 0) {
      return {
        label: 'Out of Stock',
        color: 'text-red-700',
        ...
        <div className="flex flex-col lg:flex-row gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search SKU ID, Item Name, Model Number..."
                value={search}
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {loading ? (
                ...
                skus.map((sku) => {
                  ...
                  const currentStock = sku.currentStock ?? 0;
                  const minStockLevel = sku.minStockLevel ?? sku.minStock ?? 0;
                  const stockStatus = getStockStatus(currentStock, minStockLevel);
